...
Indoor Auditorium Step into our state-of-the-art Indoor Auditorium, where modern design meets exceptional acoustics. This versatile venue is equipped with the latest technology to host a variety of events, from concerts and theater productions to conferences and lectures. With comfortable seating, excellent sightlines, and a sophisticated sound system."
        source="../assets/audi.jpg"
      />
      <Element
        heading="Room"
        comp="Experience comfort and style in our hotel rooms:
...
Discover your ideal room and enjoy a memorable stay with us."
        source="../assets/room3.jpg"
      />
      <Element
        heading="Sports"
        comp="Open Air Sports
...
Explore our facilities for an exceptional sports experience!"
        source="../assets/gym.jpg"
      />
    </div>
  );
}
