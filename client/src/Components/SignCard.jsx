        ...
        <div className="flex flex-col justify-center items-center text-center">
            ...
            <div className="border-black border-2 rounded-lg shadow-lg font-poppins px-20 p-7 m-5 text-center flex flex-col justify-center w-auto h-auto bg-orange-200">
                <div className="p-1">
                    ...
                    <input type="text" id="name"  placeholder="username" autoComplete="off" className="border-b-2  w-72 px-2 py-2 bg-inherit outline-none "></input>
                </div>
                <div className="p-1">
                ...
                <div className="p-1">
                    ...
                    <input type="password" id="pass"  placeholder="password" autoComplete="off" className="border-b-2 w-72 px-2 py-2 bg-inherit outline-none"></input>
                </div>
                <div className="p-1">
                    
                    <input type="password" id="re-enter"  placeholder="re-enter password" autoComplete="off" className="border-b-2 w-72 px-2 py-2 bg-inherit outline-none"></input>
                </div>
                <div>
