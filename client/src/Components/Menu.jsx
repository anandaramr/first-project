...
{
    return(
        <div className="text-white opacity-60 bg-gray-900 font-poppins text-lg absolute h-svh w-[65%] xsm:w-[50%] sm:w-[40%] md:w-[30%] lg:w-[27%] xl:w-[22%] left-[-70%] xsm:left-[-50%] sm:left-[-40%] md:left-[-30%] lg:left-[-27%] xl:left-[-22%] duration-200 ease-out pointer group-hover:left-0">
